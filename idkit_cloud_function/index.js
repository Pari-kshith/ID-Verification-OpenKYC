...
// Global settings object with meaningful defaults
let settings = {
  SERVER_URL: "",
  ACCESS_TOKEN: "",
...
// Set up settings listener with comprehensive error handling
...
// Export Cloud Functions with consistent error handling
...
exports.testWebhook = functions.https.onCall(
  (data, context) => webhookController.handleCallableWebhookTest(data, context)
);